...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Kashif-303/approv/blob/main/approv.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://web.facebook.com")
...
def notice():
	...
	os.system("xdg-open https://web.facebook.com")
	subprocess.check_output(["am", "start", "https://web.facebook.com"])
